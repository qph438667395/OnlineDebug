...
<body>
	...
	<div id="body">
		<div id="content">
			...
			<hr>
			<div id="img">
				<img alt="" src="images/ulogin.jpg" width="100%" height="100%">
			</div>
			<div id="form">
				<form role="form" method="post"
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-3">
							<button type="submit" class="btn btn-primary col-sm-11" formaction="utoRegister" >
								<spring:message code="register"></spring:message>
							</button>
						</div>
						<div class="col-sm-offset-1 col-sm-3">
							<button type="submit" class="btn btn-primary col-sm-11" formaction="udoLogin" >
								<spring:message code="login"></spring:message>
							</button>
						</div>
					</div>
