				...
				function() {
					...
					$("#icon")
							.on(
									"click",
									function() {
										var tr = "<tr><td><input type='text' name='input' class='form-control'></<td>"
												+ "<td><input type='text' class='form-control' name='expectedOutput'></td>"
												+ "<td><input type='text' class='form-control' name='timeLimit'></td>"
												+ "<td><input type='text' class='form-control' name='functionPointScore'></td></tr>";
										$(".table").append(tr);
									});
					$("#questionSubmit").on(
							"click",
								...
								$.ajax({
									...
									success : function(data) {
										...
										if (null != result.resultStatus) {
											if(null!=result.questionId){
												$(".questionId").val(
														result.questionId);
											}
											if(null!=result.questionType){
												if(2==result.questionType){
